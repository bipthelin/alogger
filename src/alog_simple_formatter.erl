%% @doc
%% A simple log message formatter that doesn't add any decoration.
%% @end
%% ----------------------------------------------------------------------
...
-define(LOG_MSG_FORMAT, "~s~n").
-define(LOG_MSG_FORMAT_EMPTY_TAG, "~s~n").
...
format(FormatString, Args, _Level, [], _Module, _Line, _Pid, _TimeStamp) ->
    IoUserMsg = io_lib:format(FormatString, Args),
    io_lib:format(?LOG_MSG_FORMAT_EMPTY_TAG, [IoUserMsg]);
format(FormatString, Args, _Level, _Tag, _Module, _Line, _Pid, _TimeStamp) ->
    IoUserMsg = io_lib:format(FormatString, Args),
    io_lib:format(?LOG_MSG_FORMAT, [IoUserMsg]).
